      ...
      <div class="grid grid-cols-1 gap-4 list-none lg:grid-cols-3 lg:grid-rows-3 xl:grid-cols-4 xl:grid-rows-4">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-8">
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">Laravel 10</p>
              </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">Vue 3</p>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">Vite 5</p>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">MySQL 8</p>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">Tailwind 3</p>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">Flutter 4</p>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">VS Code</p>
              </div>
            </div>
            ...
            <div class="flex justify-center">
              <div class='text-center'>
                ...
                <p class="text-gray-300 mt-2">Figma</p>
              </div>
            </div>
        ...
        <CardLayout :delay="400" class="lg:row-start-3 lg:col-span-3">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            <a v-for="row in projects" :key="row.id" :href="row.href" class="grid justify-center">
              <AppProject>
                <img :src="row.image" />
              </AppProject>
              <div class="flex justify-center">
                <p class="text-gray-300 mt-2">{{ row.title }}</p>
              </div>
            </a>
          </div>
        </CardLayout>
