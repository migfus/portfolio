import { defineComponent, computed, useSSRContext, mergeProps, withCtx, createVNode, renderSlot, ref, unref, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$7, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass(["ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl", $props.injectClass])}"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", {
                class: ["ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl", $props.injectClass]
              }, [
...
const AppButton = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$3 = {};
...
const AppLogo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$2 = {};
...
const AppProject = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("p", { class: "text-zinc-500 dark:text-zinc-400 flex flex-wrap gap-2" }, [
                createVNode("div", { class: "rounded-xl shadow-xl bg-[#262626] p-1 px-3 text-nowrap" }, [
      ...
      _push(ssrRenderComponent(_sfc_main$6, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "mailto:migfus20@gmail.com" }, {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://github.com/migfus" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://freesound.org/people/Migfus20/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://www.facebook.com/migfus20" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://www.linkedin.com/in/schwarzenegger-belonio-943446154/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://www.youtube.com/channel/UCGlgOXm1I0bz_QF1nGpkRyQ" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://discord.com/users/563556266107076630" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { href: "https://www.instagram.com/migfus20/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              ...
              createVNode("div", { class: "grid mt-4 grid-cols-4 md:grid-cols-8 lg:grid-cols-4 gap-y-4 gap-4 justifycenter w-full" }, [
                createVNode(_sfc_main$5, { href: "mailto:migfus20@gmail.com" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler icon-tabler-mail h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50",
                ...
                createVNode(_sfc_main$5, { href: "https://github.com/migfus" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler icon-tabler-brand-github h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50",
                ...
                createVNode(_sfc_main$5, { href: "https://freesound.org/people/Migfus20/" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50",
                      viewBox: "0 0 50 50",
                ...
                createVNode(_sfc_main$5, { href: "https://www.facebook.com/migfus20" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-facebook",
                ...
                createVNode(_sfc_main$5, { href: "https://www.linkedin.com/in/schwarzenegger-belonio-943446154/" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
                ...
                createVNode(_sfc_main$5, { href: "https://www.youtube.com/channel/UCGlgOXm1I0bz_QF1nGpkRyQ" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
                ...
                createVNode(_sfc_main$5, { href: "https://discord.com/users/563556266107076630" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
                ...
                createVNode(_sfc_main$5, { href: "https://www.instagram.com/migfus20/" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
      ...
      _push(ssrRenderComponent(_sfc_main$6, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><p class="text-xl text-primary dark:text-white lg:text-4xl tracking-tight"${_scopeId}> Or my <span class="text-green-600"${_scopeId}>music</span>? </p><div class="w-full mt-8 lg:max-w-none"${_scopeId}>`);
            _push2(ssrRenderComponent(AppButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { class: "lg:col-span-2 xl:col-span-1 h-full flex flex-col justify-between lg:row-span-2" }, null, _parent));
