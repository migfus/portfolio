import { defineComponent, computed, useSSRContext, mergeProps, withCtx, createVNode, renderSlot, ref, onMounted, unref, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, resolveComponent, createSSRApp, h } from "vue";
import { ssrRenderSlotInner, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import moment from "moment";
import * as VueCom from "vue-command";
import VueCom__default from "vue-command";
import { createInertiaApp } from "@inertiajs/vue3";
import createServer from "@inertiajs/vue3/server";
import { renderToString } from "@vue/server-renderer";
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "BasicTransition",
  ...
  setup(__props) {
    ...
    computed(() => {
      if ($props.delay > 0) {
        return `transition delay-[${$props.delay}ms] ease-out duration-700`;
      }
      return `transition ease-out duration-700`;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$d, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass(["ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick sm:rounded-3xl", $props.injectClass])}"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", {
                class: ["ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick sm:rounded-3xl", $props.injectClass]
              }, [
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<button${ssrRenderAttrs(mergeProps({
    type: "button",
    class: "shadow-md bg-zinc-50 dark:text-gray-200 text-sm py-2 w-full px-4 h-12 font-semibold focus:ring-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-primary duration-200 focus:ring-offset-2 focus:ring-inline-flex text-primary:dark:text-white dark:ring-1 dark:ring-white/10 ring-primary dark:bg-tertiary"
  }, _attrs))}>`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</button>`);
}
...
const AppButton = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$9 = {};
...
const AppLogo = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$8 = {};
...
const AppProject = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    -------------------------------
    v          - Portfolio Version
    cd         - Change Directory [Directory:String]
    hello      - ??
    easter-egg - 💀 Don't do it
    clear-all  - Just Clear
    -------------------------------
    `
      ),
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(VueCom__default), mergeProps({
        commands: commands.value,
        modelValue: options.value,
        "onUpdate:modelValue": ($event) => options.value = $event,
        class: "sm:rounded-3xl h-full"
      }, _attrs), {
        ...
        prompt: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(cd.value)}`);
          } else {
            return [
              createTextVNode(toDisplayString(cd.value), 1)
            ];
          }
        }),
        _: 1
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/AppCommand.vue");
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))}><div class="sm:p-4"><div class="grid grid-cols-1 gap-4 list-none lg:grid-cols-3 lg:grid-rows-3 xl:grid-cols-4 xl:grid-rows-4">`);
      _push(ssrRenderComponent(_sfc_main$c, {
        class: "lg:row-span-2 p-8",
        delay: 1e4
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex items-center gap-x-4 mb-2"${_scopeId}><img src="/images/avatar.jpg" alt="" class="h-10 w-10 rounded-full ring-1 dark:ring-white/10 ring-primary/5"${_scopeId}><div class="text-sm leading-6"${_scopeId}><p class="font-semibold text-primary dark:text-white"${_scopeId}><a href="#" class="truncate text-ellipsis"${_scopeId}><span class="absolute inset-0"${_scopeId}></span> Schwarzenegger R. Belonio </a></p></div></div><p class="text-zinc-500 dark:text-zinc-400 flex flex-wrap gap-2"${_scopeId}><div class="bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="h-4 inline-block flex-row justify-center mr-1 mb-1"${_scopeId}><path fill="#7E7F85" d="M392.8 1.2c-17-4.9-34.7 5-39.6 22l-128 448c-4.9 17 5 34.7 22 39.6s34.7-5 39.6-22l128-448c4.9-17-5-34.7-22-39.6zm80.6 120.1c-12.5 12.5-12.5 32.8 0 45.3L562.7 256l-89.4 89.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l112-112c12.5-12.5 12.5-32.8 0-45.3l-112-112c-12.5-12.5-32.8-12.5-45.3 0zm-306.7 0c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3l112 112c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256l89.4-89.4c12.5-12.5 12.5-32.8 0-45.3z"${_scopeId}></path></svg><span${_scopeId}>Web Developer</span></div><div class="bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-4 inline-block flex-row justify-center mr-1 mb-1"${_scopeId}><path fill="#7E7F85" d="M499.1 6.3c8.1 6 12.9 15.6 12.9 25.7v72V368c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V147L192 223.8V432c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V200 128c0-14.1 9.3-26.6 22.8-30.7l320-96c9.7-2.9 20.2-1.1 28.3 5z"${_scopeId}></path></svg> BGM Composer </div><div class="bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-4 inline-block flex-row justify-center mr-1 mb-1"${_scopeId}><path fill="#7E7F85" d="M499.1 6.3c8.1 6 12.9 15.6 12.9 25.7v72V368c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V147L192 223.8V432c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V200 128c0-14.1 9.3-26.6 22.8-30.7l320-96c9.7-2.9 20.2-1.1 28.3 5z"${_scopeId}></path></svg> DJI Drone Operator </div></p><p class="text-3xl mt-6 font-medium lg:text-4xl tracking-tight text-primary dark:text-white"${_scopeId}> Hey, welcome to my portfolio! </p><p class="mt-4 text-sm text-zinc-500 dark:text-zinc-400 font-light lg:text-xl"${_scopeId}> I&#39;m passionate about both technology and music. As a web developer, I bring websites and applications to life using Laravel, Vue, and Inertia. <br${_scopeId}><br${_scopeId}> When I need a break from the digital world, I hit the road on my bike for some fresh air and inspiration, which I often channel into composing my own BGM music. </p>`);
          } else {
            return [
              createVNode("div", { class: "relative flex items-center gap-x-4 mb-2" }, [
                createVNode("img", {
              ...
              createVNode("p", { class: "text-zinc-500 dark:text-zinc-400 flex flex-wrap gap-2" }, [
                createVNode("div", { class: "bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]" }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    viewBox: "0 0 640 512",
                    class: "h-4 inline-block flex-row justify-center mr-1 mb-1"
                  }, [
                    createVNode("path", {
                      fill: "#7E7F85",
                  ...
                  createVNode("span", null, "Web Developer")
                ]),
                createVNode("div", { class: "bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]" }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                ...
                createVNode("div", { class: "bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]" }, [
                  ...
                  createTextVNode(" DJI Drone Operator ")
                ])
              ]),
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "mailto:migfus20@gmail.com" }, {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://github.com/migfus" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://freesound.org/people/Migfus20/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://www.facebook.com/migfus20" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://www.linkedin.com/in/schwarzenegger-belonio-943446154/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://www.youtube.com/channel/UCGlgOXm1I0bz_QF1nGpkRyQ" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://discord.com/users/563556266107076630" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { href: "https://www.instagram.com/migfus20/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              ...
              createVNode("div", { class: "grid mt-4 grid-cols-4 md:grid-cols-8 lg:grid-cols-4 gap-y-4 gap-4 justifycenter w-full" }, [
                createVNode(_sfc_main$b, { href: "mailto:migfus20@gmail.com" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler icon-tabler-mail h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50",
                ...
                createVNode(_sfc_main$b, { href: "https://github.com/migfus" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler icon-tabler-brand-github h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50",
                ...
                createVNode(_sfc_main$b, { href: "https://freesound.org/people/Migfus20/" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50",
                      viewBox: "0 0 50 50",
                ...
                createVNode(_sfc_main$b, { href: "https://www.facebook.com/migfus20" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-facebook",
                ...
                createVNode(_sfc_main$b, { href: "https://www.linkedin.com/in/schwarzenegger-belonio-943446154/" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
                ...
                createVNode(_sfc_main$b, { href: "https://www.youtube.com/channel/UCGlgOXm1I0bz_QF1nGpkRyQ" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
                ...
                createVNode(_sfc_main$b, { href: "https://discord.com/users/563556266107076630" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
                ...
                createVNode(_sfc_main$b, { href: "https://www.instagram.com/migfus20/" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin",
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        delay: 200,
        class: "flex flex-col justify-between items-center overflow-hidden text-center lg:text-left pb-12 p-8"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full"${_scopeId}><p class="text-xl text-primary dark:text-white lg:text-4xl tracking-tight"${_scopeId}> Looking for my <span class="text-yellow-600"${_scopeId}>Web Projects</span>? </p><div class="w-full mt-8 mb-10"${_scopeId}>`);
            _push2(ssrRenderComponent(AppButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<a href="https://web.migfus.net" class="flex justify-center"${_scopeId2}><span class="text-yellow-600"${_scopeId2}>webproject</span>.migfus.net </a>`);
                } else {
                  return [
                    createVNode("a", {
                      ...
                      createVNode("span", { class: "text-yellow-600" }, "webproject"),
            ...
            _push2(`</div><p class="text-xl text-primary dark:text-white lg:text-4xl tracking-tight"${_scopeId}> Or my <span class="text-green-600"${_scopeId}>music</span>? </p><div class="w-full mt-8 lg:max-w-none"${_scopeId}><a href="https://migset.migfus.net"${_scopeId}>`);
            _push2(ssrRenderComponent(AppButton, { class: "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-green-500 dark:text-green-600 inline-block"${_scopeId2}>migset</span><span${_scopeId2}>.migfus.net</span>`);
                } else {
                  return [
                    createVNode("span", { class: "text-green-500 dark:text-green-600 inline-block" }, "migset"),
                    createVNode("span", null, ".migfus.net")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "w-full" }, [
                ...
                createVNode("div", { class: "w-full mt-8 mb-10" }, [
                ...
                createVNode("div", { class: "w-full mt-8 lg:max-w-none" }, [
                  createVNode("a", { href: "https://migset.migfus.net" }, [
                    createVNode(AppButton, { class: "" }, {
                      default: withCtx(() => [
                        createVNode("span", { class: "text-green-500 dark:text-green-600 inline-block" }, "migset"),
                        createVNode("span", null, ".migfus.net")
                      ]),
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        delay: 300,
        class: "lg:row-span-1 lg:row-start-2 lg:gap-0 lg:grid-cols-none lg:col-start-2 lg:col-span-2 p-8"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="ext-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl mb-6"${_scopeId}> Web Dev Environment </p><div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-8"${_scopeId}><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>Laravel 10</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>Vue 3</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>Vite 5</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>MySQL 8</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>Tailwind 3</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>Flutter 4</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>VS Code</p></div></div><div class="flex justify-center"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(AppLogo, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>Figma</p></div></div></div>`);
          } else {
            return [
              createVNode("p", { class: "ext-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl mb-6" }, " Web Dev Environment "),
              createVNode("div", { class: "grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-8" }, [
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "Laravel 10")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "Vue 3")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "Vite 5")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "MySQL 8")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "Tailwind 3")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "Flutter 4")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "VS Code")
                  ])
                ]),
                createVNode("div", { class: "flex justify-center" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, "Figma")
                  ])
                ])
              ])
            ];
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        delay: 400,
        class: "lg:row-start-3 lg:col-span-3 p-8"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="ext-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl mb-6"${_scopeId}> Web Projects </p><div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8"${_scopeId}><!--[-->`);
            ssrRenderList($props.projects, (row) => {
              _push2(`<a${ssrRenderAttr("href", row.project_url)} class="grid justify-center"${_scopeId}>`);
              _push2(ssrRenderComponent(AppProject, { class: "relative opacity-75" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", row.image)} class="h-24 w-24"${_scopeId2}><span class="${ssrRenderClass([
                    ...
                    ])}"${_scopeId2}>${ssrInterpolate(row.project_type.name)}</span><span class="${ssrRenderClass([
                      "inline-flex items-center rounded-xl px-2 py-1 text-xs font-sm absolute top-2 right-2",
                      `text-tertiary dark:text-white dark:bg-secondary bg-white`
                    ])}"${_scopeId2}>${ssrInterpolate(row.year)}</span>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: row.image,
                      ...
                      createVNode("span", { class: [
                        "inline-flex items-center rounded-xl px-2 py-1 text-xs font-sm absolute top-2 left-2",
                        `text-tertiary dark:text-white dark:bg-secondary bg-white`
                      ] }, toDisplayString(row.project_type.name), 1),
                      createVNode("span", { class: [
                        "inline-flex items-center rounded-xl px-2 py-1 text-xs font-sm absolute top-2 right-2",
                        `text-tertiary dark:text-white dark:bg-secondary bg-white`
                      ] }, toDisplayString(row.year), 1)
                    ];
                  }
                }),
                _: 2
              }, _parent2, _scopeId));
              _push2(`<div class="flex justify-center"${_scopeId}><p class="text-gray-600 mt-2 dark:text-gray-300"${_scopeId}>${ssrInterpolate(row.name)}</p></div></a>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
              createVNode("p", { class: "ext-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl mb-6" }, " Web Projects "),
              createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8" }, [
                (openBlock(true), createBlock(Fragment, null, renderList($props.projects, (row) => {
                  return openBlock(), createBlock("a", {
                    key: row.name,
                    href: row.project_url,
                    class: "grid justify-center"
                  }, [
                    createVNode(AppProject, { class: "relative opacity-75" }, {
                      default: withCtx(() => [
                        createVNode("img", {
                          src: row.image,
                          class: "h-24 w-24"
                    ...
                    createVNode("div", { class: "flex justify-center" }, [
                      createVNode("p", { class: "text-gray-600 mt-2 dark:text-gray-300" }, toDisplayString(row.name), 1)
                    ])
                  ], 8, ["href"]);
                }), 128))
              ])
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        delay: 500,
        class: "lg:row-span-2 overflow-hidden duration-300 p-8"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList($props.posts, (row) => {
              _push2(`<div class="mb-6"${_scopeId}><div class="relative flex items-center gap-x-4"${_scopeId}><img${ssrRenderAttr("src", row.user.avatar)}${ssrRenderAttr("alt", row.user.name + ` avatar or profile picture`)} class="h-10 w-10 rounded-full ring-1 dark:ring-white/10 ring-primary/5"${_scopeId}><div class="text-sm leading-6"${_scopeId}><p class="font-semibold text-primary dark:text-white"${_scopeId}><a href="#" class="truncate text-ellipsis"${_scopeId}><span class="absolute inset-0"${_scopeId}></span> ${ssrInterpolate(row.user.name)}</a></p>`);
              if (row.user.roles) {
                _push2(`<p class="text-zinc-500 dark:text-zinc-400"${_scopeId}>${ssrInterpolate(row.user.roles[0].name || "n/a")} ● ${ssrInterpolate(unref(moment)(row.created_at).fromNow(true))}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
              if (JSON.parse(row.content).type == "embed") {
                _push2(`<p class="mt-4 text-zinc-500 dark:text-zinc-400 line-clamp-3"${_scopeId}>${ssrInterpolate(JSON.parse(row.content).content)} <div class="mt-2"${_scopeId}>${JSON.parse(row.content).attached}</div></p>`);
              } else {
                _push2(`<p class="mt-4 text-zinc-500 dark:text-zinc-400 line-clamp-3"${_scopeId}>${ssrInterpolate(JSON.parse(row.content).content)}</p>`);
              }
              _push2(`<hr class="mt-4 border-primary/10 dark:border-white/25"${_scopeId}></div>`);
            });
            _push2(`<!--]-->`);
            _push2(ssrRenderComponent(AppButton, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList($props.posts, (row) => {
                    ...
                    createVNode("div", { class: "text-sm leading-6" }, [
                      createVNode("p", { class: "font-semibold text-primary dark:text-white" }, [
                        createVNode("a", {
                          ...
                          createVNode("span", { class: "absolute inset-0" }),
                          createTextVNode(" " + toDisplayString(row.user.name), 1)
                        ])
                      ]),
                      row.user.roles ? (openBlock(), createBlock("p", {
                        key: 0,
                        class: "text-zinc-500 dark:text-zinc-400"
                      }, toDisplayString(row.user.roles[0].name || "n/a") + " ● " + toDisplayString(unref(moment)(row.created_at).fromNow(true)), 1)) : createCommentVNode("", true)
                    ])
                  ]),
                  JSON.parse(row.content).type == "embed" ? (openBlock(), createBlock("p", {
                    key: 0,
                    class: "mt-4 text-zinc-500 dark:text-zinc-400 line-clamp-3"
                  }, [
                    createTextVNode(toDisplayString(JSON.parse(row.content).content) + " ", 1),
                    createVNode("div", {
                      innerHTML: JSON.parse(row.content).attached,
                      class: "mt-2"
                    }, null, 8, ["innerHTML"])
                  ])) : (openBlock(), createBlock("p", {
                    key: 1,
                    class: "mt-4 text-zinc-500 dark:text-zinc-400 line-clamp-3"
                  }, toDisplayString(JSON.parse(row.content).content), 1)),
                  createVNode("hr", { class: "mt-4 border-primary/10 dark:border-white/25" })
                ]);
              }), 128)),
              createVNode(AppButton, null, {
                default: withCtx(() => [
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        delay: 600,
        class: "flex flex-col h-full justify-center items-center overflow-hidden relative lg:col-span-2 lg:row-start-4",
        injectClass: "p-0"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<iframe class="w-full aspect-video" src="https://www.youtube.com/embed/WpU4kuhf5WQ?si=FM3tMM3XCml3tmX4&amp;controls=0&amp;autoplay=1&amp;showinfo=0&amp;mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen${_scopeId}></iframe>`);
          } else {
            return [
              createVNode("iframe", {
      ...
      _push(ssrRenderComponent(_sfc_main$c, {
        delay: 700,
        class: "lg:row-start-4 h-full flex flex-col justify-between p-8"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="text-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl"${_scopeId}> Download this portfolio </p><div class="md:grid md:grid-cols-2 gap-6 lg:grid-cols-1"${_scopeId}><div class="mt-4"${_scopeId}><a href="https://github.com/migfus/portfolio" class="text-sm text-pink-500 dark:text-pink-400"${_scopeId}> https://github.com/migfus/portfolio </a><div class="flex"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$b, {
              href: "https://github.com/migfus/portfolio",
              class: "mt-2"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`<span class="text-gray-200 ml-2 mt-4"${_scopeId}>Github</span></div></div></div>`);
          } else {
            return [
              createVNode("p", { class: "text-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl" }, " Download this portfolio "),
              createVNode("div", { class: "md:grid md:grid-cols-2 gap-6 lg:grid-cols-1" }, [
                createVNode("div", { class: "mt-4" }, [
                  ...
                  createVNode("div", { class: "flex" }, [
                    ...
                    createVNode("span", { class: "text-gray-200 ml-2 mt-4" }, "Github")
                  ])
                ])
              ])
            ];
      ...
      _push(ssrRenderComponent(_sfc_main$7, { class: "lg:col-span-2 xl:col-span-1 h-full flex flex-col justify-between lg:row-span-2" }, null, _parent));
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Settings/Settings.vue");
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: async (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Home/Index.vue": __vite_glob_0_0, "./Pages/Settings/Settings.vue": __vite_glob_0_1, "./Pages/Users.vue": __vite_glob_0_2 });
