import { mergeProps, useSSRContext, defineComponent, withCtx, openBlock, createBlock, createVNode, createTextVNode, computed, renderSlot, ref, onMounted, unref, toDisplayString, resolveComponent, createSSRApp, h } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderSlotInner, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">Laravel 10</p></div></div><div class="flex justify-center"><div class="text-center">`);
      _push(ssrRenderComponent(AppLogo, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50" viewBox="1 1 22 22" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"${_scopeId}><g id="Logo" transform="translate(-816.000000, -96.000000)" fill-rule="nonzero"${_scopeId}><g id="vue_line" transform="translate(816.000000, 96.000000)"${_scopeId}><path d="M24,0 L24,24 L0,24 L0,0 L24,0 Z M12.5934901,23.257841 L12.5819402,23.2595131 L12.5108777,23.2950439 L12.4918791,23.2987469 L12.4918791,23.2987469 L12.4767152,23.2950439 L12.4056548,23.2595131 C12.3958229,23.2563662 12.3870493,23.2590235 12.3821421,23.2649074 L12.3780323,23.275831 L12.360941,23.7031097 L12.3658947,23.7234994 L12.3769048,23.7357139 L12.4804777,23.8096931 L12.4953491,23.8136134 L12.4953491,23.8136134 L12.5071152,23.8096931 L12.6106902,23.7357139 L12.6232938,23.7196733 L12.6232938,23.7196733 L12.6266527,23.7031097 L12.609561,23.275831 C12.6075724,23.2657013 12.6010112,23.2592993 12.5934901,23.257841 L12.5934901,23.257841 Z M12.8583906,23.1452862 L12.8445485,23.1473072 L12.6598443,23.2396597 L12.6498822,23.2499052 L12.6498822,23.2499052 L12.6471943,23.2611114 L12.6650943,23.6906389 L12.6699349,23.7034178 L12.6699349,23.7034178 L12.678386,23.7104931 L12.8793402,23.8032389 C12.8914285,23.8068999 12.9022333,23.8029875 12.9078286,23.7952264 L12.9118235,23.7811639 L12.8776777,23.1665331 C12.8752882,23.1545897 12.8674102,23.1470016 12.8583906,23.1452862 L12.8583906,23.1452862 Z M12.1430473,23.1473072 C12.1332178,23.1423925 12.1221763,23.1452606 12.1156365,23.1525954 L12.1099173,23.1665331 L12.0757714,23.7811639 C12.0751323,23.7926639 12.0828099,23.8018602 12.0926481,23.8045676 L12.108256,23.8032389 L12.3092106,23.7104931 L12.3186497,23.7024347 L12.3186497,23.7024347 L12.3225043,23.6906389 L12.340401,23.2611114 L12.337245,23.2485176 L12.337245,23.2485176 L12.3277531,23.2396597 L12.1430473,23.1473072 Z" id="MingCute" fill-rule="nonzero"${_scopeId}></path><path d="M20.138,4.19311 C20.418,3.71708 21.0309,3.55818 21.5069,3.8382 C21.9489929,4.09821857 22.1175816,4.64526122 21.9152265,5.10321981 L21.8619,5.20715 L12.8619,20.5071 C12.6822,20.8126 12.3543,21.0001 11.9999,21.0001 C11.6849667,21.0001 11.3908926,20.8519519 11.2032218,20.6044676 L11.138,20.5071 L2.13798,5.20713 C1.85796,4.7311 2.01686,4.1182 2.4929,3.83818 C2.93492786,3.57816143 3.49497117,3.69659939 3.7969218,4.09598199 L3.86185,4.19309 L11.9999,18.0278 L20.138,4.19311 Z M15.8438,4.19315 C16.1238,3.71712 16.7367,3.55821 17.2128,3.83823 C17.6548,4.09824857 17.8233821,4.64529985 17.6210265,5.10325967 L17.5677,5.20719 L12.8619,13.2071 C12.6822,13.5125 12.3543,13.7000069 11.9999,13.7000069 C11.6849667,13.7000069 11.3908926,13.5518533 11.2032218,13.3044381 L11.138,13.2071 L6.43218,5.20719 C6.15216,4.73116 6.31106,4.11825 6.78709,3.83823 C7.22912714,3.57821143 7.78917112,3.69665801 8.0911218,4.09604184 L8.15605,4.19315 L11.9999,10.7277 L15.8438,4.19315 Z" id="形状" fill="#A0A0A0"${_scopeId}></path></g></g></g></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">Vue 3</p></div></div><div class="flex justify-center"><div class="text-center">`);
      _push(ssrRenderComponent(AppLogo, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 hover:scale-125 duration-300 text-[#A0A0A0] group-hover text-primary:dark:text-white/50" viewBox="0 0 25 25" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path d="m8.286 10.578.512-8.657a.306.306 0 0 1 .247-.282L17.377.006a.306.306 0 0 1 .353.385l-1.558 5.403a.306.306 0 0 0 .352.385l2.388-.46a.306.306 0 0 1 .332.438l-6.79 13.55-.123.19a.294.294 0 0 1-.252.14c-.177 0-.35-.152-.305-.369l1.095-5.301a.306.306 0 0 0-.388-.355l-1.433.435a.306.306 0 0 1-.389-.354l.69-3.375a.306.306 0 0 0-.37-.36l-2.32.536a.306.306 0 0 1-.374-.316zm14.976-7.926L17.284 3.74l-.544 1.887 2.077-.4a.8.8 0 0 1 .84.369.8.8 0 0 1 .034.783L12.9 19.93l-.013.025-.015.023-.122.19a.801.801 0 0 1-.672.37.826.826 0 0 1-.634-.302.8.8 0 0 1-.16-.67l1.029-4.981-1.12.34a.81.81 0 0 1-.86-.262.802.802 0 0 1-.165-.67l.63-3.08-2.027.468a.808.808 0 0 1-.768-.233.81.81 0 0 1-.217-.6l.389-6.57-7.44-1.33a.612.612 0 0 0-.64.906L11.58 23.691a.612.612 0 0 0 1.066-.004l11.26-20.135a.612.612 0 0 0-.644-.9z"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">MySQL 8</p></div></div><div class="flex justify-center"><div class="text-center">`);
      _push(ssrRenderComponent(AppLogo, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 hover:scale-125 duration-300 text-[#A0A0A0] group-hover text-primary:dark:text-white/50" viewBox="0 0 25 25" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.036c-2.667 0-4.333 1.325-5 3.976 1-1.325 2.167-1.822 3.5-1.491.761.189 1.305.738 1.906 1.345C13.387 10.855 14.522 12 17 12c2.667 0 4.333-1.325 5-3.976-1 1.325-2.166 1.822-3.5 1.491-.761-.189-1.305-.738-1.907-1.345-.98-.99-2.114-2.134-4.593-2.134zM7 12c-2.667 0-4.333 1.325-5 3.976 1-1.326 2.167-1.822 3.5-1.491.761.189 1.305.738 1.907 1.345.98.989 2.115 2.134 4.594 2.134 2.667 0 4.333-1.325 5-3.976-1 1.325-2.167 1.822-3.5 1.491-.761-.189-1.305-.738-1.906-1.345C10.613 13.145 9.478 12 7 12z"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">Tailwind 3</p></div></div><div class="flex justify-center"><div class="text-center">`);
      _push(ssrRenderComponent(AppLogo, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 hover:scale-125 duration-300 text-[#A0A0A0] group-hover text-primary:dark:text-white/50" viewBox="0 0 34 34" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path d="M18.909 14.84l-8.086 8.070 8.085 8.085h9.214l-8.073-8.083 8.073-8.073h-9.212zM18.892 1.004l-15.013 14.996 4.624 4.624 19.599-19.603h-9.194z"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">Flutter 4</p></div></div><div class="flex justify-center"><div class="text-center">`);
      _push(ssrRenderComponent(AppLogo, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 hover:scale-125 duration-300 text-[#A0A0A0] group-hover text-primary:dark:text-white/50" viewBox="0 0 34 34" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path d="M30.865 3.448l-6.583-3.167c-0.766-0.37-1.677-0.214-2.276 0.385l-12.609 11.505-5.495-4.167c-0.51-0.391-1.229-0.359-1.703 0.073l-1.76 1.604c-0.583 0.526-0.583 1.443-0.005 1.969l4.766 4.349-4.766 4.349c-0.578 0.526-0.578 1.443 0.005 1.969l1.76 1.604c0.479 0.432 1.193 0.464 1.703 0.073l5.495-4.172 12.615 11.51c0.594 0.599 1.505 0.755 2.271 0.385l6.589-3.172c0.693-0.333 1.13-1.031 1.13-1.802v-21.495c0-0.766-0.443-1.469-1.135-1.802zM24.005 23.266l-9.573-7.266 9.573-7.266z"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">VS Code</p></div></div><div class="flex justify-center"><div class="text-center">`);
      _push(ssrRenderComponent(AppLogo, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 hover:scale-125 duration-300 text-[#A0A0A0] group-hover text-primary:dark:text-white/50" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path d="M12 3H9C7.34315 3 6 4.34315 6 6C6 7.65685 7.34315 9 9 9M12 3V9M12 3H15C16.6569 3 18 4.34315 18 6C18 7.65685 16.6569 9 15 9M12 9H9M12 9H15M12 9V15M9 9C7.34315 9 6 10.3431 6 12C6 13.6569 7.34315 15 9 15M15 9C16.6569 9 18 10.3431 18 12C18 13.6569 16.6569 15 15 15C13.3431 15 12 13.6569 12 12C12 10.3431 13.3431 9 15 9ZM12 15H9M12 15V18C12 19.6569 10.6569 21 9 21C7.34315 21 6 19.6569 6 18C6 16.3431 7.34315 15 9 15" stroke="#A0A0A0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p class="text-gray-600 mt-2 dark:text-gray-300">Figma</p></div></div></div><!--]-->`);
    };
  }
});
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/DevelopmentEnvironmentCard.vue");
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  __name: "DownloadPortfolioCard",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><p class="text-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl"> Download this portfolio </p><div class="md:grid md:grid-cols-2 gap-6 lg:grid-cols-1"><div class="mt-4"><a href="https://github.com/migfus/portfolio" class="text-sm text-pink-500 dark:text-pink-400"> https://github.com/migfus/portfolio </a><div class="flex">`);
      _push(ssrRenderComponent(_sfc_main$j, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50" viewBox="0 0 24 24" stroke-width="0.8" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path stroke="none" d="M0 0h24v24H0z" fill="none"${_scopeId}></path>eb <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<span class="text-primary dark:text-gray-200 ml-2 mt-4">Github</span></div></div></div><!--]-->`);
    };
  }
});
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/DownloadPortfolioCard.vue");
...
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="w-full"><p class="text-xl font-normal tracking-tight text-primary dark:text-white lg:text-8xl"> Find me on </p></div><div class="grid mt-4 grid-cols-4 md:grid-cols-8 lg:grid-cols-4 gap-y-4 gap-4 justifycenter w-full">`);
      _push(ssrRenderComponent(_sfc_main$j, { href: "mailto:migfus20@gmail.com" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50" viewBox="0 0 24 24" stroke-width="0.8" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path stroke="none" d="M0 0h24v24H0z" fill="none"${_scopeId}></path><path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"${_scopeId}></path><path d="M3 7l9 6l9 -6"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(ssrRenderComponent(_sfc_main$j, { href: "https://github.com/migfus" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50" viewBox="0 0 24 24" stroke-width="0.8" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path stroke="none" d="M0 0h24v24H0z" fill="none"${_scopeId}></path><path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(ssrRenderComponent(_sfc_main$j, { href: "https://www.facebook.com/migfus20" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-facebook" viewBox="0 0 24 24" stroke-width="0.8" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path stroke="none" d="M0 0h24v24H0z" fill="none"${_scopeId}></path><path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(ssrRenderComponent(_sfc_main$j, { href: "https://www.linkedin.com/in/schwarzenegger-belonio-943446154/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin" viewBox="0 0 24 24" stroke-width="0.8" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path stroke="none" d="M0 0h24v24H0z" fill="none"${_scopeId}></path><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"${_scopeId}></path><path d="M8 11l0 5"${_scopeId}></path><path d="M8 8l0 .01"${_scopeId}></path><path d="M12 16l0 -5"${_scopeId}></path><path d="M16 16v-3a2 2 0 0 0 -4 0"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(ssrRenderComponent(_sfc_main$j, { href: "https://www.youtube.com/channel/UCGlgOXm1I0bz_QF1nGpkRyQ" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin" viewBox="0 0 24 24" stroke-width="0.8" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path fill-rule="evenodd" clip-rule="evenodd" d="M18.168 19.0028C20.4724 19.0867 22.41 17.29 22.5 14.9858V9.01982C22.41 6.71569 20.4724 4.91893 18.168 5.00282H6.832C4.52763 4.91893 2.58998 6.71569 2.5 9.01982V14.9858C2.58998 17.29 4.52763 19.0867 6.832 19.0028H18.168Z" stroke="#A0A0A0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"${_scopeId}></path><path fill-rule="evenodd" clip-rule="evenodd" d="M12.008 9.17784L15.169 11.3258C15.3738 11.4454 15.4997 11.6647 15.4997 11.9018C15.4997 12.139 15.3738 12.3583 15.169 12.4778L12.008 14.8278C11.408 15.2348 10.5 14.8878 10.5 14.2518V9.75184C10.5 9.11884 11.409 8.77084 12.008 9.17784Z" stroke="#A0A0A0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(ssrRenderComponent(_sfc_main$j, { href: "https://discord.com/users/563556266107076630" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin" viewBox="0 0 45 45" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path class="a" d="M17.59,34.1733c-.89,1.3069-1.8944,2.6152-2.91,3.8267C7.3,37.79,4.5,33,4.5,33A44.83,44.83,0,0,1,9.31,13.48,16.47,16.47,0,0,1,18.69,10l1,2.31A32.6875,32.6875,0,0,1,24,12a32.9643,32.9643,0,0,1,4.33.3l1-2.31a16.47,16.47,0,0,1,9.38,3.51A44.8292,44.8292,0,0,1,43.5,33s-2.8,4.79-10.18,5a47.4193,47.4193,0,0,1-2.86-3.81m6.46-2.9c-3.84,1.9454-7.5555,3.89-12.92,3.89s-9.08-1.9446-12.92-3.89"${_scopeId}></path><circle class="a" cx="17.847" cy="26.23" r="3.35"${_scopeId}></circle><circle class="a" cx="30.153" cy="26.23" r="3.35"${_scopeId}></circle></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(ssrRenderComponent(_sfc_main$j, { href: "https://www.instagram.com/migfus20/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-linkedin" viewBox="2 2 20 20" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"${_scopeId}><path fill-rule="evenodd" clip-rule="evenodd" d="M15.5 5H9.5C7.29086 5 5.5 6.79086 5.5 9V15C5.5 17.2091 7.29086 19 9.5 19H15.5C17.7091 19 19.5 17.2091 19.5 15V9C19.5 6.79086 17.7091 5 15.5 5Z" stroke="#A0A0A0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"${_scopeId}></path><path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 15C10.8431 15 9.5 13.6569 9.5 12C9.5 10.3431 10.8431 9 12.5 9C14.1569 9 15.5 10.3431 15.5 12C15.5 12.7956 15.1839 13.5587 14.6213 14.1213C14.0587 14.6839 13.2956 15 12.5 15Z" stroke="#A0A0A0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"${_scopeId}></path><rect x="15.5" y="9" width="2" height="2" rx="1" transform="rotate(-90 15.5 9)" fill="#A0A0A0"${_scopeId}></rect><rect x="16" y="8.5" width="1" height="1" rx="0.5" transform="rotate(-90 16 8.5)" stroke="#A0A0A0" stroke-linecap="round"${_scopeId}></rect></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
...
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/FindMeCard.vue");
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/TerminalCard.vue");
...
const AppButton = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$2]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList($props.data, (row) => {
        _push(`<div class="mb-6"><div class="relative flex items-center gap-x-4"><img${ssrRenderAttr("src", row.user.avatar)}${ssrRenderAttr("alt", row.user.name + ` avatar or profile picture`)} class="h-10 w-10 rounded-full ring-1 dark:ring-white/10 ring-primary/5"><div class="text-sm leading-6"><p class="font-semibold text-primary dark:text-white"><a href="#" class="truncate text-ellipsis"><span class="absolute inset-0"></span> ${ssrInterpolate(row.user.name)}</a></p>`);
        if (row.user.roles) {
          _push(`<p class="text-zinc-500 dark:text-zinc-400">${ssrInterpolate(row.user.roles[0].name || "n/a")} ● ${ssrInterpolate(unref(moment)(row.created_at).fromNow(true))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
        if (JSON.parse(row.content).type == "embed") {
          _push(`<p class="mt-4 text-zinc-500 dark:text-zinc-400 line-clamp-3">${ssrInterpolate(JSON.parse(row.content).content)} <div class="mt-2">${JSON.parse(row.content).attached}</div></p>`);
        } else {
          _push(`<p class="mt-4 text-zinc-500 dark:text-zinc-400 line-clamp-3">${ssrInterpolate(JSON.parse(row.content).content)}</p>`);
        }
        _push(`<hr class="mt-4 border-primary/10 dark:border-white/25"></div>`);
      });
      _push(`<!--]-->`);
      _push(ssrRenderComponent(AppButton, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center"${_scopeId}> More Posts... </div>`);
          } else {
            return [
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/PostsCard.vue");
...
const AppProject = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  __name: "WebProjectsCard",
  __ssrInlineRender: true,
  props: {
    data: {}
  },
  setup(__props) {
    const $props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><p class="ext-xl tracking-tight font-medium text-primary dark:text-white md:text-5xl mb-6"> Web Projects </p><div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8"><!--[-->`);
      ssrRenderList($props.data, (row) => {
        _push(`<a${ssrRenderAttr("href", row.project_url)} class="grid justify-center">`);
        _push(ssrRenderComponent(AppProject, { class: "relative opacity-75" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", row.image)} class="h-24 w-24"${_scopeId}><span class="${ssrRenderClass([
              ...
              ])}"${_scopeId}>${ssrInterpolate(row.project_type.name)}</span><span class="${ssrRenderClass([
                "inline-flex items-center rounded-xl px-2 py-1 text-xs font-sm absolute top-2 right-2",
                `text-tertiary dark:text-white dark:bg-secondary bg-white`
              ])}"${_scopeId}>${ssrInterpolate(row.year)}</span>`);
            } else {
              return [
                createVNode("img", {
                  src: row.image,
        ...
        _push(`<div class="flex justify-center"><p class="text-gray-600 mt-2 dark:text-gray-300">${ssrInterpolate(row.name)}</p></div></a>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/WebProjectsCard.vue");
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  __name: "LookingForCard",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))}><p class="text-xl text-primary dark:text-white lg:text-4xl tracking-tight"> Looking for my <span class="text-yellow-600">Web Projects</span>? </p><div class="w-full mt-8 mb-10">`);
      _push(ssrRenderComponent(AppButton, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a href="https://web.migfus.net" class="flex justify-center"${_scopeId}><span class="text-yellow-600"${_scopeId}>webproject</span>.migfus.net </a>`);
          } else {
            return [
              createVNode("a", {
      ...
      _push(`</div><p class="text-xl text-primary dark:text-white lg:text-4xl tracking-tight"> Or my <span class="text-green-600">music</span>? </p><div class="w-full mt-8 lg:max-w-none"><a href="https://mysset.migfus.net">`);
      _push(ssrRenderComponent(AppButton, { class: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-green-500 dark:text-green-600 inline-block"${_scopeId}>mysset</span><span${_scopeId}>.migfus.net</span>`);
          } else {
            return [
              createVNode("span", { class: "text-green-500 dark:text-green-600 inline-block" }, "mysset"),
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/LookingForCard.vue");
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const $props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-zinc-50 rounded-xl shadow-md p-1 px-3 text-nowrap text-primary dark:text-white group-hover text-primary:dark:text-white/50 dark:ring-1 dark:ring-gray-800 dark:bg-[#262626]" }, _attrs))}>`);
      _push(ssrRenderComponent(unref(FontAwesomeIcon), {
        icon: $props.icon,
        class: "h-4 inline-block flex-row justify-center mr-1 text-zinc-500 dark:text-zinc-400"
      }, null, _parent));
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div>`);
    };
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/AppBadge.vue");
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    onMounted(() => {
      Echo.channel("test.channel").listen("TestUpdate", (e) => {
        alert("Received submit");
      });
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="relative flex items-center gap-x-4 mb-2"><img src="/images/icon.svg" alt="Migfus Logo" class="h-10 w-10 rounded-full ring-1 dark:ring-white/10 ring-primary/5"><div class="text-sm leading-6"><p class="font-semibold text-primary dark:text-white"><a href="#" class="truncate text-ellipsis"><span class="absolute inset-0"></span> Schwarzenegger R. Belonio </a></p></div></div><div class="text-zinc-500 dark:text-zinc-400 gap-2 flex flex-wrap">`);
      _push(ssrRenderComponent(_sfc_main$8, { icon: unref(faCode) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Web Developer `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_sfc_main$8, { icon: unref(faMusic) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` BGM Composer `);
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$8, { icon: unref(faGamepad) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` DJI Drone Operator `);
          } else {
            return [
      ...
      _push(`</div><p class="text-3xl mt-6 font-medium lg:text-4xl tracking-tight text-primary dark:text-white"> Hey, welcome to my portfolio! </p><p class="mt-4 text-sm text-zinc-500 dark:text-zinc-400 font-light lg:text-xl"> I&#39;m passionate about both technology and music. As a web developer, I bring websites and applications to life using Laravel, Vue, and Inertia. <br><br> When I need a break from the digital world, I hit the road on my bike for some fresh air and inspiration, which I often channel into composing my own BGM music. </p><!--]-->`);
    };
  }
};
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Home/WelcomeCard.vue");
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<iframe class="w-full aspect-video flex flex-col h-full justify-center items-center overflow-hidden relative lg:col-span-2 lg:row-start-4" src="https://www.youtube.com/embed/WpU4kuhf5WQ?si=FM3tMM3XCml3tmX4&amp;controls=0&amp;autoplay=1&amp;showinfo=0&amp;mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`);
      _push(ssrRenderComponent(_sfc_main$f, {
        delay: 700,
      ...
      _push(ssrRenderComponent(_sfc_main$e, { class: "lg:col-span-2 xl:col-span-1 h-full flex flex-col justify-between lg:row-span-2" }, null, _parent));
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: async (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Home/DevelopmentEnvironmentCard.vue": __vite_glob_0_0, "./Pages/Home/DownloadPortfolioCard.vue": __vite_glob_0_1, "./Pages/Home/FindMeCard.vue": __vite_glob_0_2, "./Pages/Home/Index.vue": __vite_glob_0_3, "./Pages/Home/LookingForCard.vue": __vite_glob_0_4, "./Pages/Home/PostsCard.vue": __vite_glob_0_5, "./Pages/Home/TerminalCard.vue": __vite_glob_0_6, "./Pages/Home/WebProjectsCard.vue": __vite_glob_0_7, "./Pages/Home/WelcomeCard.vue": __vite_glob_0_8, "./Pages/Settings/Settings.vue": __vite_glob_0_9, "./Pages/Users.vue": __vite_glob_0_10 });
